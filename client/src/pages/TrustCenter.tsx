...
["Sharing and retention",["Infrastructure, database, payment, email and other providers may handle data only where needed. Provider disclosures and retention schedules must be kept current as integrations change.","You can permanently remove a PlusPuls account and associated app data from Settings. The public deletion guide is available at /account-deletion.","A complete controller identity and privacy contact must be published in Company & controller before public launch."]]]},
